...
public class DisplayCart extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(list==null){
         ...
         out.println("<h3><a href=ShowCategories>Start-buying</a></h3>");
        }else{
         ...
         out.println("<tr>");
         out.println("<td>Pcode</td><td>Ptitle</td><td>Desc</td><td>cat</td><td>Price</td><td>Remove</td>");
         out.println("</tr>");
         int sum=0;
         while(rs.next()){
             ...
             out.println("<td align=center>"+s5+"</td>");
